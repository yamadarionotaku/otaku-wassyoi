...
const QUERY = "genshin impact gk resin statue";
const SHOWROOM_URL =
  "https://www.alibaba.com/showroom/genshin-impact-gk-resin-statue.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=genshin+impact+gk+resin+statue";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-genshin-gk-resin-statue.json";
const USER_AGENT =
