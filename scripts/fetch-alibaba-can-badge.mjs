...
const QUERY = "anime can badge pin button";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=anime+can+badge+pin+button";
const SHOWROOM_URL =
  "https://www.alibaba.com/showroom/anime-can-badge-pin-button.html";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-can-badge.json";
const USER_AGENT =
