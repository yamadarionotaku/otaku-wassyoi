...
const QUERY = "fischl figure genshin";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/fischl-figure-genshin.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=fischl+figure+genshin";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-fischl-figure-genshin.json";
const USER_AGENT =
