...
const QUERY = "anime figure";
const SEARCH_URL = "https://www.alibaba.com/trade/search?SearchText=anime+figure";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/anime-figure.html";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-anime-figure.json";
const USER_AGENT =
