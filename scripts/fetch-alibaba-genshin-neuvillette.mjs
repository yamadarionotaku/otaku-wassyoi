...
const QUERY = "genshin impact neuvillette";
const SHOWROOM_URL =
  "https://www.alibaba.com/showroom/genshin-impact-neuvillette.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=genshin+impact+neuvillette";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-genshin-neuvillette.json";
const USER_AGENT =
