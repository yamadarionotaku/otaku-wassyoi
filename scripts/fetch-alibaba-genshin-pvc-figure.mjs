...
const QUERY = "genshin impact pvc figure";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/genshin-impact-pvc-figure.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=genshin+impact+pvc+figure";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-genshin-pvc-figure.json";
const USER_AGENT =
