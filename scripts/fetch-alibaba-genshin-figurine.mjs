...
const QUERY = "genshin impact figurine";
const SHOWROOM_URL =
  "https://www.alibaba.com/showroom/genshin-impact-figurine.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=genshin+impact+figurine";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-genshin-figurine.json";
const USER_AGENT =
