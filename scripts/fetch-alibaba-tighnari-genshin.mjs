...
const QUERY = "tighnari genshin";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/tighnari-genshin.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=tighnari+genshin";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-tighnari-genshin.json";
const USER_AGENT =
