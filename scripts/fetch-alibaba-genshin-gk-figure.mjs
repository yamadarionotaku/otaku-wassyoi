...
const QUERY = "genshin impact gk figure";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/genshin-impact-gk-figure.html";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=genshin+impact+gk+figure";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-genshin-gk-figure.json";
const USER_AGENT =
