...
const QUERY = "itabag anime";
const SEARCH_URL =
  "https://www.alibaba.com/trade/search?SearchText=itabag+anime";
const SHOWROOM_URL = "https://www.alibaba.com/showroom/itabag-anime.html";
const OUTPUT_PATH =
  "/home/yamadarion/projects/otaku-wassyoi/data/alibaba-itabag.json";
const USER_AGENT =
